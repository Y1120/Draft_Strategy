...
symbol1 = 'ARKM-USDT-SWAP'
symbol2 = 'ZEREBRO-USDT-SWAP'
amount1 = 19.6
amount2 = 0.52
...
def backtest(symbol1,symbol2):
    # Load data
    data_ai = pd.read_csv(f"C:\\Users\\theo\\Desktop\\Astra-folder\\pair_data_symbols\\{symbol1}_1m.csv")
    print(data_ai)

    data_vr = pd.read_csv(f"C:\\Users\\theo\\Desktop\\Astra-folder\\pair_data_symbols\\{symbol2}_1m.csv")
    print(data_vr)
...
def plot_trading_results(timestamps, pnl, ai_pos, vr_pos, ratio, upper_bounds, lower_bounds, means,symbol1,symbol2):
    ...
    plt.tight_layout()
    plt.savefig(f'C:\\Users\\theo\\Desktop\\pairs-over0.9\\{symbol1}&{symbol2} .png')
